  ...
  <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center" style="margin-left: auto;">
    ...
    <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
      ...
      <h1 class="my-4 text-5xl font-bold leading-tight">
        A WLAN Edge Computer 
      </h1>
      <p class="leading-normal text-2xl mb-8">
        Empowering Next-Generation Applications!
      </p>
      <a class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" href="{{url ('admin/login')}}" class="next-button">Next</a>
    </div>
    <!--Right Col-->
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
                Provides a powerful solution for real-time threat detection with the use of WLAN edge computing. By leveraging edge computing capabilities, surveillance cameras can offload video processing tasks to nearby WLAN access points. This reduces latency and network congestion, allowing for faster and more efficient video analysis. With WLAN Edge Computing, surveillance systems can detect and respond to events in real-time, enhancing security and situational awareness.
                <br />
                <br />
                <!-- Images from:
