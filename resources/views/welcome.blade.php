...
<head>
    ...
    <style>
    .gradient {
        background: linear-gradient(90deg, #1E508F 0%, #daae51 100%);
    }
    </style>
</head>
...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-24 text-right">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center" style="margin-left: auto;">
            <!--Left Col-->
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                ...
                <a class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                    href="{{url ('admin/login')}}" class="next-button">Next</a>
            </div>
            <!--Right Col-->
            <div class="w-full md:w-3/6 py-0 text-center">
                <img class="w-full md:w-5/5 z-50" width="500" src="{{ url ('admin/images/wlan8.png')}}" />
            </div>
        </div>
    </div>
        ...
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8">
                        Transform your home into a smart and connected environment with the the use of WLAN Edge
                        Computing. By integrating edge computing capabilities into smart home devices, such as
                        thermostats, security systems, and appliances, you can enhance automation and responsiveness.
                        WLAN access points act as edge computing nodes, enabling local processing and decision-making.
                        This minimizes reliance on cloud services and improves privacy and response time. With WLAN Edge
                        Computing, your smart home becomes more efficient, secure, and personalized.
                        <br />
                        <br />
              ...
              <a class="text-pink-500 underline" href="https://undraw.co/">undraw.co</a> -->
                ...
                <div class="w-full sm:w-1/2 p-6">
                    <img class="w-full md:w-4/5 z-50" src="{{ url ('admin/images/smart.png')}}" />
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <img class="w-full md:w-4/5 z-50" src="{{ url ('admin/images/video.png')}}" />
              ...
              <circle cx="600.35" cy="480.68" r="11.968" fill="#ff6347" />
                ...
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        ...
                        <p class="text-gray-600 mb-8">
                            Provides a powerful solution for real-time threat detection with the use of WLAN edge
                            computing. By leveraging edge computing capabilities, surveillance cameras can offload video
                            processing tasks to nearby WLAN access points. This reduces latency and network congestion,
                            allowing for faster and more efficient video analysis. With WLAN Edge Computing,
                            surveillance systems can detect and respond to events in real-time, enhancing security and
